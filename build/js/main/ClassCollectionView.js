...
var CollectionView = /*#__PURE__*/function () {
  ...
  _createClass(CollectionView, [{
    key: "insertCardsProduct",
    value: function insertCardsProduct(arrCards, containerCards, view) {
    ...
    key: "ajaxGetCards",
    value: function ajaxGetCards(containerCards, view) {
    ...
    key: "addEventToViewBtn",
    value: function addEventToViewBtn() {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          view.addEventListener("click", function () {
            var viewBlock = _this.checkView(this.dataset.view);
            ...
            if (viewBlock) {
              ...
              var newViewBlock = _this.createViewBlock(this.dataset.view);
    ...
    key: "checkView",
    value: function checkView(dataView) {
    ...
    value: function removeActiveClass(nameClass) {
    ...
    key: "createViewBlock",
    value: function createViewBlock(dataView) {
      var activeTab = document.querySelector(".products-block__tabs-content.active"),
